    ...
    <>
      ...
      <div className="p-16">
        <motion.div
          variants={fadeInUp}
          initial="hidden"
          whileInView="visible" className='border-2 border-amber-200 bg-black/50 backdrop-blur-md rounded-xl p-16'>
          <motion.h1
            variants={fadeInUp}
            initial="hidden"
            whileInView="visible"
          ...
          <motion.div
            ...
            <Image src="/homepageImages/subheader.jpg" width={1000} height={1000} alt='Ar/Vr' className='w-full max-w-3xl rounded-xl' />
          </motion.div>
      ...
      <div className="py-16 bg-gray-50">
        ...
        <motion.div
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-800">AR-Based Education Tools</h2>
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-800">VR Simulation for Training</h2>
            <p className="text-lg text-white">
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-800">Game Development Studio</h2>
            <p className="text-lg text-white">
